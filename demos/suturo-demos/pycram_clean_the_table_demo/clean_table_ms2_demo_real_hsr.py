...
fork = Object("Fork", "fork", "../../../resources/spoon.stl", pose=Pose([4.95, 2.73, 0.74]), color=[1, 0, 0, 1])
spoon = Object("Spoon", "spoon", "../../../resources/spoon.stl", pose=Pose([4.95, 2.6, 0.74]), color=[0, 1, 0, 1])
metalmug = Object("Metalmug", "metalmug", "../../../resources/bowl.stl", pose=Pose([4.95, 2.4, 0.765]), color=[0, 1, 0, 1])
plate = Object("Plate", "plate", "../../../resources/board.stl", pose=Pose([4.95, 2.12, 0.735]), color=[0, 1, 0, 1])
bowl = Object("Bowl", "bowl", "../../../resources/bowl.stl", pose=Pose([4.95, 1.8, 0.765]), color=[0, 1, 0, 1])
