...
fork = Object("Fork", "fork", "../../../../resources/spoon.stl", pose=Pose([-2.8, 2.3, 0.368], object_orientation), color=[1, 0, 0, 1])
spoon = Object("Spoon", "spoon", "../../../../resources/spoon.stl", pose=Pose([-2.5, 2.3, 0.368], object_orientation), color=[0, 1, 0, 1])
metalmug = Object("Metalmug", "metalmug", "../../../../resources/bowl.stl", pose=Pose([-3.1, 2.3, 0.39]), color=[0, 1, 0, 1])
plate = Object("Plate", "plate", "../../../../resources/board.stl", pose=Pose([-2.2, 2.3, 0.368], object_orientation), color=[0, 1, 0, 1])
bowl = Object("Bowl", "bowl", "../../../../resources/bowl.stl", pose=Pose([-3.4, 2.3, 0.39]), color=[0, 1, 0, 1])
